...
import TP.TP2.SensorDeployment;
...
public class GA_main {
  ...
  public static void main(String [] args) throws JMException, ClassNotFoundException {
    ...
    int numberOfVariable = 100; //
    //problem = new Schaffer("Real",numberOfVariable);
    problem = new SensorDeployment("Real",numberOfVariable);
